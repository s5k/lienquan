...
import { faCircle,faList,faFile,faNewspaper,faBell,faUsers } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className="homepage">
      <div className="home-intro">
        ...
        <div className="watch-now">
          <Link to="..//youtube.com" target="_blank" className="btn-watch-now"><FontAwesomeIcon icon="circle" className="circle"/> WATCH NOW</Link>
        </div>
      </div>
